...
std::string getStr() {
  return "dkfjakghlajfdsajglsakghklsdfjslda";
}
...
void vector_test()
{
  ...
  vector_y<int> v1;
  vector_y<int> v2(10);
  vector_y<int> v3(10, 1);
  vector_y<int> v4(a, a + 5);
  vector_y<int> v5(v2);
  vector_y<int> v6(std::move(v2));
  vector_y<int> v7{ 1,2,3,4,5,6,7,8,9 };
  vector_y<int> v8, v9, v10;
  v8 = v3;
  v9 = std::move(v3);
...
#else
  CON_TEST_P1(vector<std::string>, push_back, getStr(), LEN1 _L, LEN2 _L, LEN3 _L);
#endif
  std::cout << "\n";
  std::cout << "|---------------------|-------------|-------------|-------------|\n";
  PASSED;
